	...
	<center>
		<table border="1" width="200">
			<tr>
				<td><br>
					<center>
						<span style="color: red; font-weight: bold;">회원 강제 탈퇴</span>
					</center>

					<center>
						<!-- 로그인창 -->
						<form action="admin_member_admin_member_forced Withdrawal.do"
							method="post">
							<center>
								<br> -회원 아이디- <input type="text"
									name="user_id placeholder=" 탈퇴시킬 회원의 아이디를입력하세요."><br>
								<br>
